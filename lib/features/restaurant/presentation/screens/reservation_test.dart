...
class ReservationPage extends StatefulWidget {
  ...
  const ReservationPage({Key? key, required this.restaurant}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Stack(
          children: [
            Padding(
              // Add bottom padding for button & footer nav
                          ...
                          child: Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                icon:
                                    Icon(FontAwesomeIcons.plus, color: primary),
                                style: IconButton.styleFrom(
                                  backgroundColor: Colors.white,
                                  shape: const CircleBorder(),
                                  minimumSize: const Size(38, 38),
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      _footerNavItem(
                          "Activities", FontAwesomeIcons.bolt, false, primary),
                      _footerNavItem(
